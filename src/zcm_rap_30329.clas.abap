CLASS zcm_rap_30329 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    INTERFACES if_abap_behv_message . " INTERFACE FOR BAHVIOR RELATED MESSAGES
    INTERFACES if_t100_message .
    INTERFACES if_t100_dyn_msg .

    CONSTANTS:
      BEGIN OF date_interval,
        msgid TYPE symsgid VALUE 'ZRAP_MSG_30329',
...
CLASS zcm_rap_30329 IMPLEMENTATION.
